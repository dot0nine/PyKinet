#-------------------------------------------------------------------------------
# Name:        PyKinet
# Purpose:     to process kinetics curves of nitrophenol reduction into aniline
#              on gold nanoparticles using the model published by Ballauf
#              dx.doi.org/10.1021/jp5060606
#
# Author:      Andrey Romanyuk
#
# Copyright:   (c) Andrey Romanyuk 2020
#-------------------------------------------------------------------------------
